          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                @can('isSuperAdmin')
                {{-- @can('checkUser', $user->roles) --}}  {{-- login user no role == userrole  (checkUser GATE) --}}
                ...
                @endcan
                {{-- @endcan --}}
                <a role="button" class="btn btn-link" href="{{ route('users.show', $user->id) }}" title="Show User">Show</a> </div>
              </td>
            </tr>
            @endforeach
          </tbody>
